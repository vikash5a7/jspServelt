...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from seller  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Seller Name Already Exits");							
							%>
					   ...
					   {
					String sta="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into seller(name,pass,email,mobile,addr,dob,gender,pin,location,image,status,acc_type) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													out.println("Seller Registered Sucessfully ");							
